...
import com.sj.huakr.utils.Constants;
import com.sj.huakr.utils.MD5;
import com.sj.huakr.utils.Util;
...
public class Test extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView= findViewById(R.id.tv_prepay_id);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.confirmButton:        //微信支付
                genPayReq();//生成签名参数
                sendPayReq();//调起支付
                break;
                case R.id.submitButton://提交订单
    ...
    private void genPayReq() {
        ...
        if (resultunifiedorder!=null) {
            ...
            Toast.makeText(Test.this, "prepayid为空", Toast.LENGTH_SHORT).show();
        }
    ...
    private class PrePayIdAsyncTask extends AsyncTask<String,Void, Map<String, String>>
    {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            dialog = ProgressDialog.show(Test.this, "提示", "正在提交订单");
